    ...
    <section className="flex w-full justify-center py-20">
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <a className="group" href="https://www.linkedin.com/in/chetananandareddykukutla/">
              <BsLinkedin className="h-12 w-12 duration-100 group-hover:fill-gray-900 md:h-14 md:w-14" />
            </a>
            <a className="group" href="https://github.com/ChetanAnandaReddyKukutla">
            ...
            <a className="group" href="https://x.com/Itona3007">
          ...
          <p className="rounded-md bg-gray-50 px-2 py-0.5 text-gray-700 shadow-xs">Chetan Ananda Reddy Kukutla</p>
        </div>
      </div>
    </section>
  );
