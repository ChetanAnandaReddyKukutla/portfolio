  ...
  return (
    <section className="mt-32 flex flex-col justify-center">
      <div className="flex w-full flex-col items-center gap-8 rounded-t-md p-4">
        <h3 className="text-center font-mono text-4xl font-semibold">Projects</h3>
      ...
      <a href="https://github.com/ChetanAnandaReddyKukutla?tab=repositories" className="group mt-4">
